...
mkdir -p "$OUTPUT_DIR"
OUTPUT="$OUTPUT_DIR/${LABEL}_clusters.csv"

echo "=== Set clusters mode ==="
...
echo "=== Record clusters mode for ${DURATION}s -> ${OUTPUT} ==="
...
echo "Done: $OUTPUT"
echo "Summary: ${OUTPUT_DIR}/${LABEL}_clusters_summary.csv"
